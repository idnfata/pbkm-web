...
import iconCutTime from './icon/cut-time.svg';
import iconOverTime from './icon/overtime.svg';
import iconSick from './icon/sick.svg';
import iconLoan from './icon/loan.svg';
import iconExchange from './icon/exchange.svg';
import iconLate from './icon/late.svg';
